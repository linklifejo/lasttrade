        ...
        try:
            ...
            with get_db_connection() as conn:
                ...
                initial_stocks = [
                    ...
                    # 저가주
                    ("015760", "한국전력", 18000), ("034020", "두산에너빌리티", 15000), ("010140", "삼성중공업", 8500), 
                    ("000720", "현대건설", 35000), ("011200", "HMM", 17000), ("003490", "대한항공", 22000), ("009830", "한화솔루션", 30000),
                    ("017670", "SK텔레콤", 50000), ("011170", "롯데케미칼", 150000), ("010950", "S-Oil", 70000), 
                    ("086790", "하나금융지주", 45000), ("009150", "삼성전기", 140000), ("032830", "삼성생명", 70000), 
                    ("000810", "삼성화재", 250000), ("259960", "크래프톤", 200000)
                ]
